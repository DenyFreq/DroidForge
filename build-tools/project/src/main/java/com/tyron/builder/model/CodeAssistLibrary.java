...
public class DroidForgeLibrary {
    ...
    public static DroidForgeLibrary forJar(File jar) {
        DroidForgeLibrary codeAssistLibrary = new DroidForgeLibrary();
    ...
    public boolean equals(@Nullable Object obj) {
        if (obj instanceof DroidForgeLibrary) {
            DroidForgeLibrary that = ((DroidForgeLibrary) obj);
