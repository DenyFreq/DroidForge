...
import com.tyron.builder.model.DroidForgeAndroidLibrary;
...
public class AndroidModuleImpl extends JavaModuleImpl implements AndroidModule {
    ...
    private final List<DroidForgeLibrary> libraries = new ArrayList<>();
    ...
    public List<DroidForgeLibrary> getDroidForgeLibraries() {
        return libraries;
    }

    @Override
    public void addLibrary(@NonNull @NotNull DroidForgeLibrary library) {
        libraries.add(library);

        if (library instanceof DroidForgeAndroidLibrary) {
            DroidForgeAndroidLibrary androidLibrary = (DroidForgeAndroidLibrary) library;
