...
public class JavaModuleImpl extends ModuleImpl implements JavaModule {
    ...
    private final Map<String, DroidForgeLibrary> mLibraryHashMap;
    ...
    @Override
    public void putLibraryHashes(Map<String, DroidForgeLibrary> hashes) {
        mLibraryHashMap.putAll(hashes);
    }

    @Nullable
    @Override
    public DroidForgeLibrary getLibrary(String hash) {
    ...
    @Override
    public void addLibrary(@NonNull DroidForgeLibrary library) {
