### DroidForge v0.2.9 ALPHA

### ViewBinding support 
- Real time code completions and analysis for view binding generated files. To enable the feature, check [this pull request.](https://github.com/tyron12233/DroidForge/pull/331).
...
- DroidForge can now compile libaries that are built with JDK 11. (Like sora-editor).
...
### XML Completions
- After comppleting an attribute, the completion window will be shown automatically if applicable. See [this pull request](https://github.com/tyron12233/DroidForge/pull/368)
