...
For java variables, DroidForge now suggests names based on the type.
...
The `url` key specifies the url that the dependency resolver will look for dependencies. The `name` key specifies the name of the directory DroidForge will use to store caches.
...
![Screenshot_20220206-154414_DroidForge](https://user-images.githubusercontent.com/74818961/152680963-09deab8a-39be-43fa-b4cc-eeb8fae8039c.png)
