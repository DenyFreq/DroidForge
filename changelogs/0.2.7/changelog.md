...
### Save button
- There is now a button to force DroidForge to save the opened files to disk. Its located at the folder icon on the toolbar next to the refresh option.
